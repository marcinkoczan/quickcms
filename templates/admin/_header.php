...
<head>
  ...
  <script type="text/javascript">
    ...
    var oTempEl;
    var sExtNotice = '<?php echo $config['admin_lang'] == 'pl' ? 'Ta funkcjonalność nie występuje w tym narzędziu.<br />Opcja ta i wiele innych znajduje się w narzędziu <a href="http://opensolution.org/?p=Quick.Cms_editions" target="_blank">Quick.Cms.Ext</a>' : 'This functionality has extended version or is not included in this script.<br />You can get this functionality and much more if you will buy <a href="http://opensolution.org/?p=Quick.Cms_editions" target="_blank">Quick.Cms.Ext</a>'; ?>';
