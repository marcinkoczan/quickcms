    ...
    <tr>
      <td id="eventsLinks">
        ...
        <div id="addInfo" class="homeBox">
          ...
          <div><iframe src="http://opensolution.org/additional-info,<?php echo $config['admin_lang']; ?>,<?php echo $config['version']; ?>.html?sUrl=<?php echo $_SERVER['HTTP_HOST']; ?>&amp;sVer=Quick.Cms"></iframe></div>
        </div>
      ...
      <td id="news">
        <div id="newsBox" class="homeBox">
          ...
          <iframe src="http://opensolution.org/news,<?php echo $config['admin_lang']; ?>,<?php echo $config['version']; ?>.html?sUrl=<?php echo $_SERVER['HTTP_HOST']; ?>&amp;sVer=Quick.Cms"></iframe>
        </div>
      </td>
    </tr>
  </table>
