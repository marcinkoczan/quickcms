...
?>
<h1><img src="<?php echo $config['dir_templates']; ?>admin/img/ico_lang.gif" alt="<?php echo $lang['Languages']; ?>" /><?php echo $lang['Languages'].( isset( $sLanguage ) ? ' '.$sLanguage : null ); ?><a href="<?php echo $config['manual_link']; ?>instruction#1.6" title="<?php echo $lang['Manual']; ?>" target="_blank"></a></h1>
<?php
